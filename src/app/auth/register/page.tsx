          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 ${errors.displayName ? 'border-red-400' : 'border-gray-200 focus:border-[#8B5CF6]'} bg-white text-gray-900 placeholder:text-gray-400 transition-colors focus:outline-none`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 ${errors.confirmPassword ? 'border-red-400' : 'border-gray-200 focus:border-[#8B5CF6]'} bg-white text-gray-900 placeholder:text-gray-400 transition-colors focus:outline-none`}
            ...
            <div className="flex items-start gap-3 pt-1">
              <button
                ...
                className={`mt-0.5 w-5 h-5 rounded border-2 flex items-center justify-center flex-shrink-0 transition-colors ${acceptTerms ? 'bg-[#8B5CF6] border-[#8B5CF6]' : 'border-gray-300 hover:border-[#8B5CF6]'}`}
              >
                {acceptTerms && (
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#8B5CF6] to-[#A78BFA] text-white font-semibold hover:shadow-lg hover:shadow-[#8B5CF6]/30 transition-all duration-200 disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
